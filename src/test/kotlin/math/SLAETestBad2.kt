...
class SLAETestBad2 {
    ...
    fun init() {
        ...
        testMatrix.setMatrixElement(0, 0, "0")
        testMatrix.setMatrixElement(0, 1, "0")
        testMatrix.setMatrixElement(0, 2, "0")
        testMatrix.setMatrixElement(0, 3, "0")
        testMatrix.setMatrixElement(1, 0, "0")
        testMatrix.setMatrixElement(1, 1, "0")
        testMatrix.setMatrixElement(1, 2, "0")
        testMatrix.setMatrixElement(1, 3, "0")
        testMatrix.setMatrixElement(2, 0, "0")
        testMatrix.setMatrixElement(2, 1, "0")
        testMatrix.setMatrixElement(2, 2, "0")
        testMatrix.setMatrixElement(2, 3, "0")
